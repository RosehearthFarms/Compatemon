...
object CompatemonDataKeys {
    ...
    const val MOD_ID_PEHKUI = "pehkui"
    const val MOD_ID_APOTHEOSIS = "apotheosis"
    ...
    const val MOD_ID_FORGE = "forge"
    const val MOD_ID_NEOFORGE = "neoforge"
    const val MOD_ID_QUILT = "quilt"
    const val MOD_ID_COMMON = "c"
